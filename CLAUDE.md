...
- `debug_archive/round1_crops/` — stray debug crop images from round 1's investigation, kept
  only because `LOG.md`'s "Testing 1" entry references them by name; not part of the
  deliverable, safe to ignore.
...
- `DOCUMENTATION.md` — intended for the final 1-2 page deliverable write-up (empty as of this
  writing).
